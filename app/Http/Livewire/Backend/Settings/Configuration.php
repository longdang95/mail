...
class Configuration extends Component {
    ...
    public function update() {
        ...
        $settings = Setting::whereIn('key', ['domains', 'fetch_seconds', 'email_limit', 'fetch_messages_limit', 'forbidden_ids', 'blocked_domains', 'cron_password', 'delete', 'random', 'custom', 'after_last_email_delete', 'date_format', 'disable_used_email', 'allow_reuse_email_in_days', 'captcha', 'recaptcha2', 'recaptcha3', 'hcaptcha', 'add_mail_in_title'])->get();
